...
class WorkView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        holiday_sum = models.Work.objects.filter(type=models.Types.HOLIDAY).filter(dateFrom__year=timezone.now().year).aggregate(holiday_sum=((Sum('duration')) / Value(60*60*24*(40/30.5))+1))['holiday_sum']
        holiday_total = 31
